        ...
        <div style={{ background: "#fff", borderRadius: "20px", overflow: "hidden", boxShadow: "0 20px 50px rgba(37,99,235,.15)" }}>
          ...
          <div style={{ padding: "35px" }}>
            ...
            <div style={{ maxWidth: "600px", margin: "auto" }}>
              ...
              <input placeholder="Email Address (to receive design proof)" value={email} onChange={(e) => (() => { const v = e.target.value.replace(/\s/g, ''); e.target.value = v; setEmail(v); })()} style={inputStyle} />
