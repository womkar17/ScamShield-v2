...
export default function FakeFlightTicketSim({ onComplete }) {
  ...
  const fields = [{"n":"pnr_number","p":"6-Character Booking Reference (PNR)","t":"text","max":6},{"n":"phone","p":"10-Digit Passenger Mobile Number","t":"tel","max":10}];
    ...
    <div style={{ background: '#18181b', border: '1px solid #27272a', borderRadius: '18px', overflow: 'hidden', fontFamily: 'var(--font-sans, sans-serif)', color: '#f4f4f5', boxShadow: '0 16px 40px rgba(0,0,0,0.6)' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #1d4ed8, #18181b)', padding: '1.4rem 2rem', borderBottom: '1px solid #2563eb', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            <h3 style={{ margin: 0, color: '#fff', fontSize: '1.2rem', fontWeight: 'bold' }}>{"✈️ SkyWays Airlines — Booking PNR #AI-9921 Verification"}</h3>
      ...
      <div style={{ padding: '2.2rem' }}>
        <p style={{ color: '#e4e4e7', fontSize: '1rem', lineHeight: '1.65', marginBottom: '1.5rem' }}>
          {"Your roundtrip flight ticket from Delhi to Mumbai for tomorrow is placed on administrative hold due to revised aviation fuel surcharges. Pay the difference of ₹1,850 to confirm boarding pass."}
        </p>
        <div style={{ background: '#27272a', borderLeft: '4px solid #3b82f6', padding: '1.4rem', borderRadius: '8px', color: '#bfdbfe', fontSize: '0.95rem', marginBottom: '2rem', whiteSpace: 'pre-wrap' }}>
          {"Booking PNR: AI-9921 | Pending Fuel Surcharge: ₹1,850\nWarning: Failure to settle surcharge in 3 hours will result in ticket cancellation."}
        </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.8rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.4rem' }}>
            ...
            >
              ...
              <span>{"Check PNR Status on Official Airline Website Directly"}</span>
            </button>
            ...
            >
              <span style={{ fontSize: '1.2rem' }}>⚠️</span>
              <span>{"Pay ₹1,850 Fuel Surcharge to Confirm Ticket"}</span>
            </button>
          </div>
        </div>
      </div>
