...
export default function LPGCylinderBookingSiteSim({ onComplete }) {
  return (
    <GovtSchemeSim
      schemeName="LPG Cylinder Booking Site"
      icon="🔥"
      smsText="Your LPG cylinder booking is pending. Complete Aadhaar-linked bank verification now to avoid cancellation of your subsidy."
      siteUrl="lpg-cylinder-booking.in"
