// Complete, unified Scam Modules dictionary
// Exporting all modules including existing baseline, Phase 1/2/3 local expansions, and new scam modules from NEW_SCAM_SHIELD_UPDATED
...

{
    ...
    quiz: [{ q: 'Where should you check your real PM Kisan installment status?', opts: ['Any SMS link received', 'pmkisan.gov.in official website/app', 'A forwarded WhatsApp link', 'A phone call from an unknown number'], ans: 1, exp: 'Only the official portal and app show accurate, secure beneficiary status.' }, { q: 'Does the PM Kisan scheme ever ask for OTP to "release" an installment?', opts: ['Yes, always', 'No, never', 'Only for large amounts', 'Only on weekends'], ans: 1, exp: 'Government disbursements are automatic to verified accounts; OTP requests are always a scam sign.' }, { q: 'What should you do if you get a suspicious PM Kisan SMS?', opts: ['Click the link to check', 'Forward it to family so they can also check', 'Verify directly on the official portal or helpline and ignore the link', 'Reply with your Aadhaar number to confirm'], ans: 2, exp: 'Always bypass the link entirely and go to trusted official sources.' }]
  },

{
    ...
    quiz: [{ q: 'What is the official website for creating an ABHA Health ID?', opts: ['Any hospital-branded site', 'abha.abdm.gov.in', 'A link shared over WhatsApp', 'A third-party health app'], ans: 1, exp: 'ABDM (Ayushman Bharat Digital Mission) operates the only official ABHA portal.' }, { q: 'Why is sharing medical history on an unfamiliar site risky?', opts: ['It is not risky', 'It can be sold or used for targeted scams and insurance fraud', 'It speeds up registration', 'Hospitals require it publicly'], ans: 1, exp: 'Sensitive health data combined with Aadhaar details enables highly targeted fraud.' }, { q: 'A message threatens loss of hospital benefits unless you register in the next hour. This is:', opts: ['Normal government process', 'A classic urgency-based scam tactic', 'Required by law', 'A hospital policy'], ans: 1, exp: 'Government health scheme enrolment is never time-boxed to force a rushed decision.' }]
  },

{
    ...
    quiz: [{ q: 'Can any legitimate trading bot guarantee 15% daily returns?', opts: ['Yes, with good AI', 'No — this is a guaranteed sign of fraud', 'Only for crypto', 'Only for institutional investors'], ans: 1, exp: 'Markets are inherently unpredictable; fixed guaranteed returns are illegal to promise and always fraudulent.' }, { q: 'Where can you verify if an investment platform is legitimate in India?', opts: ['Its own website', 'SEBI website (sebi.gov.in)', 'Social media reviews', 'The app store rating'], ans: 1, exp: 'SEBI maintains registries of authorised investment advisors and brokers.' }, { q: 'What happens when scam trading apps ask for extra fees before withdrawal?', opts: ['Normal processing charge', 'A tactic to extract more money — your original deposit is already gone', 'Required by tax law', 'A one-time formality'], ans: 1, exp: 'Legitimate platforms never charge fees to release your own funds; this is a common final-stage extraction tactic.' }]
  },

{
    ...
    quiz: [{ q: 'How are legitimate EV subsidies usually applied?', opts: ['Via a separate paid online portal after purchase', 'Deducted directly from the invoice by the authorised dealer', 'Sent as cash by post', 'Only through social media ads'], ans: 1, exp: 'Government EV subsidies are built into the purchase invoice through registered dealers.' }, { q: 'A site asks for a "processing fee" to release your government subsidy. This is:', opts: ['Standard practice', 'A major red flag of fraud', 'Required by RTO', 'Optional but recommended'], ans: 1, exp: 'Government benefits are never gated behind a private processing fee.' }, { q: 'Where should you verify official EV subsidy scheme details?', opts: ['Random ad links', 'heavyindustries.gov.in or your state transport department', 'WhatsApp forwards', 'Dealer\'s personal number only'], ans: 1, exp: 'Official ministry and state government sites list authentic, current subsidy rules.' }]
  },

{
    ...
    quiz: [{ q: 'Why do scammers ask for a very small "re-delivery fee"?', opts: ['To be helpful', 'To lower your suspicion while still stealing full card details', 'It is a government tax', 'To cover printing costs'], ans: 1, exp: 'A small amount feels low-risk, but the real goal is capturing your complete card details for later misuse.' }, { q: 'Where should you track a real FedEx/DHL shipment?', opts: ['Any SMS link', 'The courier\'s official website/app using your tracking number', 'A forwarded WhatsApp message', 'A phone call from an unknown number'], ans: 1, exp: 'Only the official courier site/app gives accurate shipment status.' }, { q: 'What is most dangerous to enter on an unexpected courier payment page?', opts: ['Your name', 'CVV and full card number', 'Your city', 'Your email'], ans: 1, exp: 'CVV and full card number allow unauthorized transactions to be made immediately.' }]
  },

{
    ...
    quiz: [{ q: 'Do you ever need to enter your UPI PIN to RECEIVE money?', opts: ['Yes, always', 'No, never — PIN is only for sending money', 'Only for large amounts', 'Only from unknown senders'], ans: 1, exp: 'This is the single most important UPI safety rule: PIN entry always means you are paying, not receiving.' }, { q: 'How are real UPI refunds credited to you?', opts: ['By scanning a QR code and entering PIN', 'Automatically, with no PIN needed', 'By calling customer care and sharing PIN', 'By installing a screen-share app'], ans: 1, exp: 'Refunds are pushed to your account automatically by the payment processor.' }, { q: 'A QR code scam creates urgency by:', opts: ['Giving you unlimited time', 'Setting a short "refund window" to pressure quick action', 'Asking you to think it over', 'Sending it from a bank branch'], ans: 1, exp: 'Artificial time pressure is a classic tactic to prevent victims from thinking critically.' }]
  },

{
    ...
    quiz: [{ q: 'Why do scammers ask victims to install a screen-sharing app?', opts: ['To fix the phone faster', 'To see your screen and control approvals in real time', 'It is required by RBI', 'To speed up refunds'], ans: 1, exp: 'Screen-sharing apps give scammers live visibility and control to authorize fraudulent payments.' }, { q: 'Does a real bank/UPI refund ever need your PIN to be "verified"?', opts: ['Yes, always', 'No — refunds are automatic and PIN-free', 'Only for amounts over ₹10,000', 'Only on weekends'], ans: 1, exp: 'PIN is never needed to receive a refund; this is always a scam request.' }, { q: 'What should you do if "customer care" calls first about your refund?', opts: ['Follow their instructions immediately', 'Hang up and call the bank\'s official number yourself', 'Share your PIN to save time', 'Install any app they suggest'], ans: 1, exp: 'Always independently verify by contacting the bank through official channels.' }]
  },

{
    ...
    quiz: [{ q: 'What should you always check before approving a UPI AutoPay mandate?', opts: ['Only the first charge amount', 'The maximum recurring limit set in the mandate', 'The app\'s color scheme', 'The time of day'], ans: 1, exp: 'Scammers hide a high recurring limit behind a tiny first charge.' }, { q: 'Where can you review and cancel active UPI mandates?', opts: ['Only by calling the merchant', 'Inside your UPI app\'s mandate/AutoPay management section', 'You cannot cancel a mandate', 'Only your bank branch can do it'], ans: 1, exp: 'All UPI apps let users view and revoke active mandates directly.' }, { q: 'A "free trial" mandate for ₹1 is always safe because the charge is tiny.', opts: ['True', 'False — the hidden recurring limit is what matters', 'True only for known brands', 'True if approved via SMS'], ans: 1, exp: 'The visible trial charge is a decoy; the real risk is the approved recurring limit.' }]
  },

{
    ...
    quiz: [{ q: 'What is the most reliable way to catch a QR sticker swap scam?', opts: ['Trust the sticker\'s appearance', 'Check the payee name shown before confirming payment', 'Pay faster to avoid queues', 'Ask other customers'], ans: 1, exp: 'The payee name on the confirmation screen reveals the true recipient regardless of which QR was scanned.' }, { q: 'What should a shopkeeper do to prevent QR sticker fraud?', opts: ['Nothing, it\'s not their responsibility', 'Regularly inspect the displayed QR code for tampering or overlays', 'Remove QR payments entirely', 'Change the shop location'], ans: 1, exp: 'Periodic physical checks catch pasted-over fraudulent QR stickers.' }, { q: 'If the payee name doesn\'t match the store, what should you do?', opts: ['Enter your PIN anyway', 'Cancel the transaction and alert the shop', 'Pay cash and ignore it', 'Scan again quickly'], ans: 1, exp: 'Mismatched payee names mean the payment is going to the wrong account — always cancel.' }]
  },

{
    ...
    quiz: [{ q: 'What should you do first if your card gets stuck in an ATM?', opts: ['Re-enter your PIN as suggested by a stranger', 'Immediately call your bank to block the card', 'Wait for the "helper" to fix it', 'Leave without reporting it'], ans: 1, exp: 'Blocking the card immediately prevents any fraudulent use even if it has been physically trapped.' }, { q: 'What is a "Lebanese loop"?', opts: ['A type of ATM receipt', 'A physical device inserted to trap cards inside the ATM slot', 'A banking app feature', 'A type of PIN'], ans: 1, exp: 'It is a card-trapping device fraudsters insert into ATM card slots.' }, { q: 'Why do card-trapping fraudsters watch you re-enter your PIN?', opts: ['To help you faster', 'To capture your PIN via shoulder-surfing before retrieving the trapped card', 'It is required by the bank', 'To count ATM users'], ans: 1, exp: 'Combining your PIN with the physically trapped card gives them full account access.' }]
  },

{
    ...
    quiz: [{ q: 'Do you need a third-party app to "activate" contactless/NFC payments on your card?', opts: ['Yes, always', 'No — it is enabled automatically by your bank', 'Only for new cards', 'Only for premium cards'], ans: 1, exp: 'Banks enable contactless functionality by default; no external activation app is needed.' }, { q: 'Why is entering your CVV into an "NFC activation" app dangerous?', opts: ['It is not dangerous', 'CVV combined with card number/expiry enables card-not-present fraud', 'CVV is public information', 'It only affects contactless payments'], ans: 1, exp: 'CVV is the key piece needed for unauthorized online transactions.' }, { q: 'Where should you get apps related to your bank card?', opts: ['Any app claiming to be official', 'Only your bank\'s verified official app/source', 'Third-party app stores', 'Links from SMS messages'], ans: 1, exp: 'Always verify you are using your bank\'s genuinely published app.' }]
  },

{
    ...
    quiz: [{ q: 'Does testing your card for "skimming vulnerability" ever require entering your CVV online?', opts: ['Yes, it is standard practice', 'No — this is always a data-harvesting scam', 'Only for old cards', 'Only for contactless cards'], ans: 1, exp: 'No legitimate security check requires submitting your full card details online.' }, { q: 'What is a real way to protect against contactless/RFID skimming?', opts: ['Entering your card details on a "scan" website', 'Using an RFID-blocking wallet or sleeve', 'Sharing your CVV with the bank by SMS', 'Disabling your bank account'], ans: 1, exp: 'Physical RFID shielding blocks unauthorized scans without exposing your data anywhere.' }, { q: 'A "free card safety scan" website is likely:', opts: ['A bank service', 'A data-harvesting scam', 'A government tool', 'Required before using contactless cards'], ans: 1, exp: 'These sites exist solely to collect full card data for fraud.' }]
  },

{
    ...
    quiz: [{ q: 'Does a real KYC update ever require your ATM PIN?', opts: ['Yes, for identity confirmation', 'No, never — PIN is only for authorizing transactions', 'Only for savings accounts', 'Only during festivals'], ans: 1, exp: 'Identity verification uses documents, not your transaction PIN.' }, { q: 'Where should you complete a genuine KYC update?', opts: ['Any link received by SMS', 'Your bank\'s official app, website, or branch', 'A third-party "KYC portal"', 'A number that called you'], ans: 1, exp: 'Only official, verified bank channels handle KYC updates.' }, { q: 'A form asking for Aadhaar, PAN, card number AND PIN together is:', opts: ['Normal for KYC', 'Extremely dangerous — enough for full account takeover', 'Required by RBI', 'Safe if the site looks professional'], ans: 1, exp: 'This combination of data allows a scammer to fully impersonate and control your identity and account.' }]
  },
...

{
    ...
    quiz: [{ q: 'Why would a parcel-tracking app request SMS read permission?', opts: ['To notify you of delivery updates', 'To silently intercept OTPs for banking fraud', 'It is a standard Android requirement', 'To improve GPS accuracy'], ans: 1, exp: 'Legitimate tracking apps have no need to read your SMS inbox; this is a hallmark of banking trojans.' }, { q: 'What does Accessibility Service permission allow a malicious app to do?', opts: ['Nothing significant', 'Read on-screen content and simulate taps, including inside banking apps', 'Only change font size', 'Access the camera only'], ans: 1, exp: 'Accessibility Service was designed to assist users with disabilities but is heavily abused by trojans to control the screen.' }, { q: 'What should you do if you suspect a banking trojan on your phone?', opts: ['Restart the phone and continue normally', 'Disconnect internet, uninstall the app, and contact your bank immediately', 'Wait and see if anything happens', 'Just change your phone lock screen PIN'], ans: 1, exp: 'Quick isolation and bank notification can prevent or limit unauthorized transactions.' }]
  },

{
    ...
    quiz: [{ q: 'What usually precedes a large-scale ATM cash-out attack?', opts: ['A random bank error', 'Earlier card skimming or trapping that captured card data and PIN', 'A software update', 'A scheduled maintenance'], ans: 1, exp: 'Cash-out attacks rely on previously stolen card data and PINs cloned onto multiple cards.' }, { q: 'What is an effective way to catch a cash-out attack early?', opts: ['Checking your statement once a year', 'Enabling instant transaction alerts via SMS/app', 'Ignoring small transactions', 'Using the same PIN everywhere'], ans: 1, exp: 'Real-time alerts let you notice and report unauthorized withdrawals within minutes.' }, { q: 'What should you do immediately if you notice withdrawals you didn\'t make?', opts: ['Wait a day to confirm', 'Call your bank\'s fraud helpline immediately to block the card', 'Post about it on social media first', 'Try to withdraw the rest yourself'], ans: 1, exp: 'Immediate action can stop further fraudulent withdrawals and start the dispute process.' }]
  },

{
    ...
    quiz: [{ q: 'What is the safest response to a stranger offering to help at a Cash Deposit Machine?', opts: ['Let them handle it to save time', 'Politely decline and complete the transaction yourself, or ask official bank staff', 'Give them your cash to hold', 'Share your account number with them'], ans: 1, exp: 'Only you or verified bank staff should handle your cash and account details at a CDM.' }, { q: 'What should you verify immediately after any CDM deposit?', opts: ['Nothing, the receipt is enough', 'Your account balance via SMS alert or banking app', 'The machine\'s serial number', 'The time on the receipt only'], ans: 1, exp: 'Checking your real balance confirms the deposit actually reached your own account.' }, { q: 'Why do CDM scammers rush or crowd the victim?', opts: ['To be friendly', 'To block their view and swap account numbers or receipts unnoticed', 'Machines require quick operation', 'To help you finish faster'], ans: 1, exp: 'Distraction and obstruction are key tactics to manipulate the transaction unnoticed.' }]
  },

{
    ...
    url: 'fake-call-simulator.com', badge: 'URGENT!', amount: '₹15,000', amountLabel: 'Emergency Transfer', fee: 'Verify Now', feeNote: 'Verify with family first',
...

{
    ...
    url: 'internal-corp-portal.com', badge: 'CEO Order', amount: 'Confidential', amountLabel: 'Urgent Transfer', fee: 'Verify Order', feeNote: 'Check company channels',
...

{
    ...
    url: 'support-verify.com', badge: 'Support Alert', amount: 'N/A', amountLabel: 'Account Issue', fee: 'Verify Support', feeNote: 'Check official site',
...

{
    ...
    url: 'hiring-portal.com', badge: 'Interview', amount: '12 LPA', amountLabel: 'Job Offer', fee: 'Confirm Offer', feeNote: 'Check domain',
...

{
    ...
    url: 'ai-wealth-growth.com/dashboard', badge: 'Market Alert', amount: 'Guaranteed Returns', amountLabel: 'Invest Today', fee: 'Deposit Amount', feeNote: 'Verify SEBI',
...

{
    ...
    url: 'match-finder.com', badge: 'Love Match', amount: 'N/A', amountLabel: 'Urgent Help', fee: 'Verify Identity', feeNote: 'Video call first',
...

{
    ...
    url: 'bank-support.com', badge: 'Security Alert', amount: 'N/A', amountLabel: 'Account Secure', fee: 'Do Not Share', feeNote: 'Hang up',
...

{
    ...
    url: 'facebook-deals.com', badge: 'Offer', amount: 'Variable', amountLabel: 'Item Sale', fee: 'Verify Seller', feeNote: 'Meet in person',
...

{
    ...
    url: 'insta-verify.com', badge: 'Verification', amount: 'Status', amountLabel: 'Get Blue Tick', fee: 'Verify', feeNote: 'Official App Only',
    fields: [{ n: 'verify', p: 'Check Profile Authenticity', t: 'checkbox' }],
...

{
    ...
    url: 'x-verify.com', badge: 'Verified', amount: 'Subscription', amountLabel: 'Upgrade', fee: 'Verify', feeNote: 'Official site only',
    fields: [{ n: 'verify', p: 'Check Profile Authenticity', t: 'checkbox' }],
...

{
    ...
    url: 'giveaway-portal.com', badge: 'Win Prize', amount: 'High', amountLabel: 'Contest', fee: 'Verify', feeNote: 'Check profile',
    fields: [{ n: 'verify', p: 'Check Profile Authenticity', t: 'checkbox' }],
...

{
    ...
    url: 'crypto-group.com', badge: 'Join Now', amount: 'High', amountLabel: 'Investment', fee: 'Join Group', feeNote: 'Verify source',
    fields: [{ n: 'name', p: 'Full Name', t: 'text' }],
...

{
    ...
    url: 'discord-gift.com', badge: 'Nitro', amount: 'Gift', amountLabel: 'Free Nitro', fee: 'Click Link', feeNote: 'Official App Only',
...

{
    ...
    url: 'snap-chat.com', badge: 'Match', amount: 'N/A', amountLabel: 'Chat', fee: 'Verify', feeNote: 'Video call',
    fields: [{ n: 'name', p: 'Full Name', t: 'text' }],
...

{
    ...
    url: 'jobs-recruit.com', badge: 'Job Offer', amount: 'Salary', amountLabel: 'Apply', fee: 'Do Not Pay', feeNote: 'Research company',
...

{
    ...
    url: 'x-official-crypto-giveaway.org/claim-btc', badge: 'Giveaway', amount: 'BTC', amountLabel: 'Win Crypto', fee: 'Verify', feeNote: 'Regulated only',
...

{
    ...
    url: 'amazon-deals-india.shop/iphone15', badge: 'Deal', amount: 'Low', amountLabel: 'Shop', fee: 'Verify', feeNote: 'Use HTTPS',
...

{
    ...
    fields: [
      ...
      { n: 'demat', p: 'Demat Account Broker', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN (to pay fee)', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'dematId', p: 'Depository Participant (DP) ID', t: 'text' },
      { n: 'pan', p: 'PAN Card Number', t: 'text' },
      { n: 'bankAcc', p: 'Bank Account Number', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN (to pay allotment fee)', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'tradingId', p: 'Trading Account ID', t: 'text' },
      { n: 'bankAcc', p: 'Linked Bank Account', t: 'text' },
      { n: 'upiId', p: 'UPI ID', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN (for VIP upgrade)', t: 'password' }
    ],
...

{
    ...
    fields: [
      ...
      { n: 'mobile', p: 'Mobile Number', t: 'tel' },
      { n: 'bankAcc', p: 'Bank Account Number', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN (to verify account)', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'name', p: 'Full Name', t: 'text' },
      { n: 'mobile', p: 'Mobile Number', t: 'tel' },
      { n: 'upiId', p: 'UPI ID (for receiving income)', t: 'text' },
      { n: 'referral', p: 'Referral Code (Who invited you?)', t: 'text' }
    ],
...

{
    ...
    fields: [
      ...
      { n: 'aadhaar', p: 'Aadhaar Number', t: 'text' },
      { n: 'bankAcc', p: 'Bank Account Number', t: 'text' },
      { n: 'nominee', p: 'Nominee Name & Details', t: 'text' }
    ],
...

{
    ...
    fields: [
      ...
      { n: 'mobile', p: 'Mobile Number', t: 'tel' },
      { n: 'bankAcc', p: 'Bank Account Number', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN (for locker fee)', t: 'password' }
    ],
    exposed: ['Name', 'Mobile', 'Bank Account', 'UPI PIN'],
...

{
    ...
    fields: [
      ...
      { n: 'pan', p: 'PAN Card Number', t: 'text' },
      { n: 'bankAcc', p: 'Bank Account Number', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN (for registration)', t: 'password' }
    ],
...

{
    ...
    diff: "high",
    tag: "Medical Scams",
    url: "secure-portal-auth.com",
    badge: "Urgent Action",
    amount: "₹0",
    amountLabel: "Amount at Risk",
    fee: "Action Required",
    feeNote: "Immediate action requested",
    fields: [],
    exposed: [
      "Phone Number",
      "Payment Details"
    ...
    tips: [
      "Always hang up and call the hospital's official landline or your family member directly. Official institutions do not demand instant UPI payments via random WhatsApp numbers."
    ],
    quiz: [
      {
        q: "What is the primary psychological tactic used in the Fake Hospital scam?",
        opts: [
          "Offering a massive discount on medical bills",
          "Creating extreme time pressure and panic to force a quick payment",
          "Sending a detailed PDF of the patient's medical history",
          "Asking for the patient's blood type"
        ],
        ans: 1,
        exp: "Scammers rely on time pressure (like a 15-minute countdown) to make you panic and pay without verifying the facts."
      }
    ]
  },

{
    ...
    tips: [
      "Rely on official national emergency numbers (like 108 in India) or save the direct contact numbers of your local trusted hospitals in advance."
    ],
    quiz: [
      {
        q: "Why is it dangerous to click the very first 'Sponsored' link when searching for emergency services?",
        opts: [
          "Sponsored links are always slower to load",
          "Search engines do not fully verify if the ad belongs to a legitimate emergency service provider",
          "Sponsored links charge more for the ambulance ride",
          "The ambulance will get lost using Google Maps"
        ],
        ans: 1,
        exp: "Scammers frequently buy ad space to place their fake websites at the top of search results, bypassing organic verification."
      }
    ]
  },

{
    ...
    tips: [
      "Legitimate online pharmacies always require a valid doctor's prescription. Beware of sites that offer heavy discounts, have a countdown timer at checkout, and disable Cash on Delivery (COD)."
    ],
    quiz: [
      {
        q: "Which of these is a major red flag when buying prescription medicines online?",
        opts: [
          "The website requires you to upload a valid doctor's prescription",
          "The website offers a 60% discount but disables Cash on Delivery (COD)",
          "The website lists a registered physical address",
          "The website has a customer care phone number"
        ],
        ans: 1,
        exp: "Scammers disable COD because they need you to pay upfront before you realize the medicine isn't coming."
      }
    ]
  },

{
    ...
    flags: [
      "The Cheap Consultation Trap"
    ],
    tips: [
      "Only use well-known, official telemedicine platforms (like Practo, Apollo, or Tata 1mg). Never click links in random SMS messages to book health appointments."
    ],
    quiz: [
      {
        q: "Why do fake telemedicine scams usually charge a very small fee (like ₹199)?",
        opts: [
          "Because online doctors are cheaper than in-person doctors",
          "To make the victim think it's a low-risk trial and easily part with their payment details",
          "Because the government subsidizes fake telemedicine apps",
          "To pay for the video call software"
        ],
        ans: 1,
        exp: "A low fee lowers your guard. The scammers don't just want the ₹199; they want to steal your card details or UPI PIN during the transaction."
      }
    ]
  },

{
    ...
    tips: [
      "Real government digital health IDs (like ABHA) are completely free. If a site asks for a 'processing fee' or 'card generation fee', it is a scam."
    ],
    quiz: [
      {
        q: "What is the biggest red flag when applying for a government document or health card online?",
        opts: [
          "The website asks for your date of birth",
          "The website requires a small 'processing fee' via UPI or card for a free government scheme",
          "The website takes more than 2 minutes to load",
          "The website asks for your name"
        ],
        ans: 1,
        exp: "Official digital health IDs are free. Scammers use tiny 'processing fees' to steal your financial data."
      }
    ]
  },

{
    ...
    tips: [
      "Legitimate blood banks and hospitals will NEVER ask a blood donor to pay a 'registration fee' or 'verification fee'. Donating blood is always free."
    ],
    quiz: [
      {
        q: "You want to donate blood for an urgent online request. What should make you instantly realize it's a scam?",
        opts: [
          "The hospital is far away",
          "The patient has a rare blood type",
          "The registration portal asks for a ₹49 refundable verification fee",
          "The post has thousands of retweets"
        ],
        ans: 2,
        exp: "No legitimate hospital or NGO will ever ask a donor to pay money to donate blood."
      }
    ]
  },

{
    ...
    tips: [
      "Never donate through random WhatsApp links. Always Google the official temple trust website and look for verified payment gateways and official government registration numbers."
    ],
    quiz: [
      {
        q: "Why do scammers frequently use WhatsApp forwards for Temple Donation scams?",
        opts: [
          "WhatsApp has the best payment gateway",
          "People are more likely to trust and click a link if it was forwarded by a family member or friend",
          "WhatsApp automatically verifies temple trusts",
          "It is the only way to send links in India"
        ],
        ans: 1,
        exp: "Social proof is powerful. If a relative forwards a religious message, most people assume it is safe and legitimate without checking the URL."
      }
    ]
  },

{
    ...
    tips: [
      "Before donating, always look up the NGO on the government's official Darpan portal. If a random ad forces you to enter your PAN card for a small donation, close the page."
    ],
    quiz: [
      {
        q: "What sensitive piece of information do fake NGO portals often request by falsely promising tax exemptions?",
        opts: [
          "Your home address",
        ...
        ans: 1,
        exp: "Fake NGOs use the promise of 80G tax receipts to trick you into exposing your PAN card, which they use for identity theft."
      }
    ]
  },

{
    ...
    tips: [
      "Official government portals in India usually end in '.gov.in' or '.nic.in'. Websites ending in '.com', '.org', or '.in' claiming to be official relief funds are usually fake."
    ],
    quiz: [
      {
        q: "Which website domain suffix is a strong indicator that a disaster relief fund is an official Indian government portal?",
        opts: [
          ".org",
          ".com",
          ".gov.in",
        ...
        ans: 2,
        exp: "Legitimate Indian government websites exclusively use .gov.in or .nic.in domains."
      }
    ]
  },

{
    ...
    tips: [
      "Always check the organizer's profile, look for updates on the campaign, and reverse-image search the photos used in the pitch."
    ],
    quiz: [
      {
        q: "What is a common trick used by fake crowdfunding campaigns on social media?",
        opts: [
          "They only accept cash donations",
          "They steal photos from real, older campaigns to manufacture fake emergencies",
          "They always require you to upload your ID to donate",
          "They refund your money if the goal isn't met"
        ],
        ans: 1,
        exp: "Scammers prey on impulse and empathy by using stolen, tragic photos to make you donate quickly without researching the organizer."
      }
    ]
  },

{
    ...
    tips: [
      "If a campaign claims a child is at a specific hospital, call the hospital's official landline to verify if the patient and the fundraising campaign are real."
    ],
    quiz: [
      {
        q: "Why do fake medical campaigns often include a countdown timer?",
        opts: [
          "To show when the hospital closes",
          "To trigger a sense of panic so you donate immediately without verifying",
          "To track how long the website has been active",
          "To follow government fundraising regulations"
        ],
        ans: 1,
        exp: "Timers create false urgency, bypassing your logical thinking and pushing you to act purely on emotion."
      }
    ]
  },

{
    ...
    tips: [
      "Legitimate army welfare funds (like the Armed Forces Battle Casualties Welfare Fund) have specific, official government bank accounts and will not use random UPI IDs or WhatsApp links."
    ],
    quiz: [
      {
        q: "If you want to donate to an Army Welfare fund, what is the safest approach?",
        opts: [
          "Click the link in a WhatsApp forward that has a tricolor flag",
          "Pay the UPI ID provided in a patriotic Facebook post",
          "Go directly to the official government website (.gov.in) to find the verified bank details",
          "Download a donation app sent via SMS"
        ],
        ans: 2,
        exp: "Never trust links on social media for official funds. Always verify the exact bank details on the official government or defense website."
      }
    ]
  },

{
    ...
    tips: [
      "Legitimate browser extensions from the official Chrome Web Store do not require you to pay a 'human verification' or 'bot check' fee via credit card to activate them."
    ],
    quiz: [
      {
        q: "You install a free browser extension and a popup asks for a ₹99 credit card fee for 'bot verification'. What should you do?",
        opts: [
          "Pay it, since it's a very small amount",
          "Use a UPI ID instead of a credit card to be safe",
          "Immediately uninstall the extension and run an antivirus scan",
          "Enter a fake credit card number"
        ],
        ans: 2,
        exp: "This is a classic bait-and-switch scam. The extension is malicious and trying to steal your payment details."
      }
    ]
  },

{
    ...
    tips: [
      "If you get a virus warning in your web browser, close the browser immediately. Real antivirus software alerts come from your system tray, not a website, and they don't demand instant payment."
    ],
    quiz: [
      {
        q: "What is the primary goal of a 'Scareware' popup?",
        opts: [
          "To update your computer's drivers",
          "To make you panic about a fake virus so you pay for a fake solution",
          "To securely backup your files",
          "To optimize your internet speed"
        ],
        ans: 1,
        exp: "Scareware relies on fear. They manufacture a fake crisis so you hand over your credit card details to 'fix' it."
      }
    ]
  },

{
    ...
    tips: [
      "Google Chrome updates automatically in the background. It will NEVER redirect you to a website that asks for your Google password or a credit card fee to download a patch."
    ],
    quiz: [
      {
        q: "A website tells you Chrome is outdated and asks for a ₹5 card payment to verify you are human before downloading the patch. Is this normal?",
        opts: [
          "Yes, Google charges a small fee for security patches",
          "No, browser updates are always free and never require a credit card for verification",
          "Yes, but only if you use a Mac",
          "No, you should only pay via UPI"
        ],
        ans: 1,
        exp: "Browser updates are entirely free and automated. Any request for payment or passwords to update your browser is a scam."
      }
    ]
  },

{
    ...
    tips: [
      "This is usually just a web browser stuck in full-screen mode. Pressing Esc, F11, or Ctrl+Alt+Delete to close the browser will instantly 'fix' the issue without paying anyone."
    ],
    quiz: [
      {
        q: "If your screen locks up with a blue error message telling you to call a 1-800 support number, what is the best first step?",
        opts: [
          "Call the number immediately to prevent data loss",
          "Enter your credit card details to buy the diagnostic software",
          "Press Ctrl+Alt+Delete to force close your web browser",
          "Unplug your internet router and wait for 24 hours"
        ],
        ans: 2,
        exp: "Most fake lock screens are just web browser tricks. Force-closing the browser removes the fake warning."
      }
    ]
  },

{
    ...
    tips: [
      "Paying the ransom on a locked screen never guarantees your files will be decrypted. The best defense is regular offline backups and never plugging in unknown devices."
    ],
    quiz: [
      {
        q: "You find a USB drive in your company's parking lot labeled 'Confidential Layoffs'. What should you do?",
        opts: [
          "Plug it into your work laptop but run an antivirus scan first",
          "Plug it into your personal laptop at home instead",
          "Give it to your IT security department without plugging it in anywhere",
          "Format the drive immediately so you can use it for free storage"
        ],
        ans: 2,
        exp: "Never connect unknown devices to any computer. Handing it directly to IT ensures it is handled safely without compromising any networks."
      }
    ]
  },
...

{
    id: 143,
    icon: '🛕',
    title: 'Fake Pilgrimage Package',
    desc: 'Fraudulent pilgrimage tour packages offering fake bookings and huge discounts.',
    diff: 'med',
    tag: 'Travel Scam',
    url: 'pilgrimage-booking-india.com',
    badge: 'Limited Time Offer',
    amount: '₹4,999',
    amountLabel: 'Complete Package',
    fee: 'Advance Booking',
    feeNote: 'Non-refundable',
    fields: [
      { n: 'name', p: 'Full Name', t: 'text' },
      { n: 'phone', p: 'Mobile Number', t: 'tel' },
      { n: 'payment', p: 'UPI ID', t: 'text' }
    ],
...

{
    id: 144,
    icon: '🚆',
    title: 'Fake Railway Refund',
    desc: 'Fake refund messages pretending to be from Indian Railways.',
    diff: 'med',
    tag: 'Travel Scam',
    url: 'railway-refund-help.com',
    badge: 'Refund Pending',
    amount: '₹2,450',
    amountLabel: 'Claim Refund',
    fee: 'Verification Charge',
    feeNote: 'Refund expires today',
    fields: [
      { n: 'pnr', p: 'PNR Number', t: 'text' },
      { n: 'upi', p: 'UPI ID', t: 'text' }
    ],
...

{
    id: 145,
    icon: '✈️',
    title: 'Fake Airport Assistance',
    desc: 'Fraudsters offering fake airport VIP assistance and fast-track services.',
    diff: 'med',
    tag: 'Travel Scam',
    url: 'airport-vip-help.com',
    badge: 'VIP Assistance',
    amount: '₹1,999',
    amountLabel: 'Fast Track Entry',
    fee: 'Booking Fee',
    feeNote: 'Limited seats',
    fields: [
      { n: 'name', p: 'Passenger Name', t: 'text' },
      { n: 'pnr', p: 'Flight PNR', t: 'text' }
    ],
...

{
    id: 146,
    icon: '📦',
    title: 'Fake FedEx Delivery',
    desc: 'Fake parcel delivery notifications pretending to be FedEx.',
    diff: 'high',
    tag: 'Parcel Scam',
    url: 'fedex-track-update.com',
    badge: 'Parcel On Hold',
    amount: '₹99',
    amountLabel: 'Delivery Fee',
    fee: 'Custom Charge',
    feeNote: 'Pay immediately',
    fields: [
      { n: 'tracking', p: 'Tracking Number', t: 'text' },
      { n: 'card', p: 'Card Number', t: 'text' }
    ],
...

{
    id: 147,
    icon: '📦',
    title: 'Fake DHL Delivery',
    desc: 'Fraudulent DHL parcel delivery notification scam.',
    diff: 'high',
    tag: 'Parcel Scam',
    url: 'dhl-delivery-update.com',
    badge: 'Shipment Delayed',
    amount: '₹120',
    amountLabel: 'Delivery Charge',
    fee: 'Processing Fee',
    feeNote: 'Required today',
    fields: [
      { n: 'tracking', p: 'Tracking ID', t: 'text' },
      { n: 'upi', p: 'UPI ID', t: 'text' }
    ],
...

{
    id: 148,
    icon: '📦',
    title: 'Fake Blue Dart Tracking',
    desc: 'Fake Blue Dart parcel tracking scam.',
    diff: 'high',
    tag: 'Parcel Scam',
    url: 'bluedart-track-now.com',
    badge: 'Delivery Failed',
    amount: '₹75',
    amountLabel: 'Redelivery Fee',
    fee: 'Service Charge',
    feeNote: 'Required within 2 hours',
    fields: [
      { n: 'tracking', p: 'Tracking Number', t: 'text' },
      { n: 'mobile', p: 'Mobile Number', t: 'tel' }
    ],
...

{
    id: 149,
    icon: '📮',
    title: 'Fake India Post Tracking',
    desc: 'Fake India Post parcel tracking messages.',
    diff: 'high',
    tag: 'Parcel Scam',
    url: 'indiapost-track-online.com',
    badge: 'Parcel Waiting',
    amount: '₹50',
    amountLabel: 'Processing Fee',
    fee: 'Verification',
    feeNote: 'Pay now',
    fields: [
      { n: 'tracking', p: 'Article Number', t: 'text' },
      { n: 'upi', p: 'UPI ID', t: 'text' }
    ],
...

{
    id: 150,
    icon: '🚚',
    title: 'Courier Redelivery Fee Scam',
    desc: 'Fraudsters demand small fees for fake redelivery attempts.',
    diff: 'med',
    tag: 'Parcel Scam',
    url: 'parcel-redelivery.com',
    badge: 'Redelivery Needed',
    amount: '₹99',
    amountLabel: 'Redelivery Charge',
    fee: 'Mandatory Payment',
    feeNote: 'Today only',
    fields: [
      { n: 'address', p: 'Delivery Address', t: 'text' },
      { n: 'card', p: 'Card Details', t: 'text' }
    ],
    ...
    quiz: [
      {
        q: 'What is the biggest red flag in a courier redelivery scam?',
        opts: ['A small unexpected payment request', 'Courier tracking number', 'Official courier app', 'Delivery notification'],
        ans: 0,
        exp: 'Scammers often request a small payment to steal your financial information.'
      },
      {
        q: 'How should you verify a delivery?',
        opts: ['Click the SMS link', 'Track it on the official courier website', 'Reply to the message', 'Pay immediately'],
        ans: 1,
        exp: 'Always verify parcel status through the courier’s official website or app.'
      },
      {
        q: 'What should you avoid entering on suspicious courier websites?',
        opts: ['Tracking number', 'Delivery address', 'Card or banking details', 'Parcel weight'],
        ans: 2,
        exp: 'Never enter your banking details on unknown courier websites.'
      }
    ]
  },

{
    id: 151,
    icon: '🛃',
    title: 'Customs Clearance Scam',
    desc: 'Fake customs officers demand clearance charges for parcels.',
    diff: 'high',
    tag: 'Parcel Scam',
    url: 'customs-clearance-help.com',
    badge: 'Parcel Held',
    amount: '₹3,500',
    amountLabel: 'Customs Fee',
    fee: 'Immediate Payment',
    feeNote: 'Release today',
    fields: [
      { n: 'tracking', p: 'Tracking Number', t: 'text' },
      { n: 'upi', p: 'UPI ID', t: 'text' }
    ],
    ...
    quiz: [
      {
        q: 'What do customs clearance scammers usually claim?',
        opts: ['Your parcel requires customs fees', 'Your password has expired', 'Your SIM card is blocked', 'Your internet is slow'],
        ans: 0,
        exp: 'Scammers pretend your parcel is held at customs and demand payment.'
      },
      {
        q: 'How should you verify customs charges?',
        opts: ['Pay immediately', 'Contact the courier or customs office directly', 'Reply to the SMS', 'Call the unknown number'],
        ans: 1,
        exp: 'Verify directly with the courier or official customs authorities.'
      },
      {
        q: 'What is a common pressure tactic?',
        opts: ['Discount offers', 'Urgent payment threats', 'Cashback rewards', 'Free delivery'],
        ans: 1,
        exp: 'Urgency is used to trick victims into paying without verification.'
      }
    ]
  },

{
    ...
    desc: 'Fake electricity bill payment messages.',
    diff: 'high',
    tag: 'Utility Scam',
    url: 'electricity-payment-now.com',
    badge: 'Power Disconnection',
    amount: '₹1,480',
    amountLabel: 'Outstanding Bill',
    fee: 'Reconnect Fee',
    feeNote: 'Pay within 30 minutes',
    fields: [
      { n: 'consumer', p: 'Consumer Number', t: 'text' },
      { n: 'upi', p: 'UPI ID', t: 'text' }
    ],
    ...
    quiz: [
      {
        q: 'How do electricity bill scammers create panic?',
        opts: ['Threaten immediate power disconnection', 'Offer discounts', 'Send coupons', 'Provide cashback'],
        ans: 0,
        exp: 'Fake disconnection notices pressure victims into making quick payments.'
      },
      {
        q: 'Where should you verify your electricity bill?',
        opts: ['Official electricity provider portal', 'WhatsApp', 'Telegram', 'Unknown website'],
        ans: 0,
        exp: 'Always verify bills using the official utility website or app.'
      },
      {
        q: 'What should you avoid?',
        opts: ['Checking the official app', 'Paying via links received in SMS', 'Calling customer support', 'Viewing your bill history'],
        ans: 1,
        exp: 'Never make bill payments through unknown SMS links.'
      }
    ]
  },

{
    id: 153,
    icon: '💧',
    title: 'Water Bill Scam',
    desc: 'Fake municipal water bill payment scam.',
    diff: 'med',
    tag: 'Utility Scam',
    url: 'waterbill-payment.com',
    badge: 'Water Supply Notice',
    amount: '₹680',
    amountLabel: 'Pending Bill',
    fee: 'Late Fee',
    feeNote: 'Pay today',
    fields: [
      { n: 'consumer', p: 'Consumer ID', t: 'text' }
    ],
    ...
    quiz: [
      {
        q: 'How should you verify a water bill?',
        opts: ['Use the official municipal portal', 'Click the SMS link', 'Reply to the sender', 'Trust any payment request'],
        ans: 0,
        exp: 'Always verify bills on the official municipal website.'
      },
      {
        q: 'What is a common sign of a fake water bill?',
        opts: ['Urgent payment demand', 'Printed receipt', 'Customer ID', 'Bill number'],
        ans: 0,
        exp: 'Scammers often create urgency to trick victims.'
      },
      {
        q: 'What should you do before paying?',
        opts: ['Verify with your municipality', 'Pay immediately', 'Share OTP', 'Ignore the bill forever'],
        ans: 0,
        exp: 'Confirm the bill with your local water authority.'
      }
    ]
  },

{
    id: 154,
    icon: '🔥',
    title: 'Gas Connection Scam',
    desc: 'Fake gas connection verification and payment scam.',
    diff: 'med',
    tag: 'Utility Scam',
    url: 'gas-connection-update.com',
    badge: 'Connection Verification',
    amount: '₹999',
    amountLabel: 'Renew Connection',
    fee: 'Processing Fee',
    feeNote: 'Required today',
    fields: [
      { n: 'consumer', p: 'Consumer Number', t: 'text' }
    ...
    quiz: [
      {
        q: 'What do gas connection scammers usually request?',
        opts: ['Verification payment', 'Gas refill schedule', 'Safety tips', 'Cylinder booking number'],
        ans: 0,
        exp: 'Fake verification fees are commonly used in gas connection scams.'
      },
      {
        q: 'Who should you contact to verify your gas connection?',
        opts: ['Official gas distributor', 'Unknown caller', 'Random website', 'Social media page'],
        ans: 0,
        exp: 'Always verify requests with your official gas agency.'
      },
      {
        q: 'What should you avoid?',
        opts: ['Official mobile app', 'Paying unknown agents', 'Customer care', 'Checking booking status'],
        ans: 1,
        exp: 'Never make payments to unverified agents.'
      }
    ]
  },

{
    id: 155,
    icon: '⛽',
    title: 'LPG Booking Scam',
    desc: 'Fake LPG booking and payment websites.',
    diff: 'med',
    tag: 'Utility Scam',
    url: 'lpg-booking-online.com',
    badge: 'Book Cylinder',
    amount: '₹1,050',
    amountLabel: 'Cylinder Booking',
    fee: 'Advance Payment',
    feeNote: 'Instant confirmation',
    fields: [
      { n: 'consumer', p: 'Consumer ID', t: 'text' }
    ],
    exposed: ['Consumer Details'],
    ...
    quiz: [
      {
        q: 'Where should LPG cylinders be booked?',
        opts: ['Official distributor app or website', 'Unknown website', 'Random WhatsApp number', 'Telegram'],
        ans: 0,
        exp: 'Always use the official LPG booking portal.'
      },
      {
        q: 'What is a common lure?',
        opts: ['Huge discounts on LPG cylinders', 'Weather alerts', 'Bank rewards', 'Insurance offers'],
        ans: 0,
        exp: 'Scammers attract victims using fake discount offers.'
      },
      {
        q: 'What should you verify before paying?',
        opts: ['Distributor details', 'Logo color', 'Website font', 'Banner image'],
        ans: 0,
        exp: 'Verify the LPG distributor before making payments.'
      }
    ]
  },

{
    id: 156,
    icon: '🏷️',
    title: 'FASTag KYC Scam',
    desc: 'Fake FASTag KYC update messages.',
    diff: 'high',
    tag: 'Phishing',
    url: 'fastag-kyc-update.com',
    badge: 'KYC Required',
    amount: 'Update FASTag',
    amountLabel: 'Avoid Suspension',
    fee: 'Verification',
    feeNote: 'Complete today',
    fields: [
      { n: 'mobile', p: 'Registered Mobile', t: 'tel' },
      { n: 'otp', p: 'OTP', t: 'text' }
    ],
    ...
    quiz: [
      {
        q: 'What do FASTag KYC scammers try to steal?',
        opts: ['OTP and banking details', 'Vehicle color', 'Driving experience', 'Fuel receipts'],
        ans: 0,
        exp: 'Their goal is to steal OTPs and financial credentials.'
      },
      {
        q: 'Where should FASTag KYC be updated?',
        opts: ['Official FASTag provider website', 'SMS link', 'WhatsApp', 'Telegram'],
        ans: 0,
        exp: 'Update KYC only through your official FASTag issuer.'
      },
      {
        q: 'Should you share OTP with anyone?',
        opts: ['No', 'Yes', 'Only over phone', 'Only through SMS'],
        ans: 0,
        exp: 'Never share OTPs with anyone.'
      }
    ]
  },

{
    id: 157,
    icon: '🛣️',
    title: 'Toll Payment Scam',
    desc: 'Fake toll payment and FASTag deduction notifications.',
    diff: 'high',
    tag: 'Phishing',
    url: 'toll-payment-alert.com',
    badge: 'Pending Toll',
    amount: '₹250',
    amountLabel: 'Pay Now',
    fee: 'Penalty',
    feeNote: 'Avoid fine',
    fields: [
      { n: 'vehicle', p: 'Vehicle Number', t: 'text' }
    ],
    ...
    quiz: [
      {
        q: 'What is the safest way to verify a toll payment?',
        opts: ['Check your official FASTag account', 'Click the SMS link', 'Reply to the sender', 'Ignore all toll transactions'],
        ans: 0,
        exp: 'Verify deductions using your official FASTag account.'
      },
      {
        q: 'What is a common scam tactic?',
        opts: ['Urgent unpaid toll notice', 'Discount coupon', 'Fuel cashback', 'Parking receipt'],
        ans: 0,
        exp: 'Fake unpaid toll notices are used to steal payments.'
      },
      {
        q: 'What should you avoid?',
        opts: ['Official app', 'Unknown payment links', 'Customer support', 'Transaction history'],
        ans: 1,
        exp: 'Never pay through unknown links.'
      }
    ]
  },

{
    id: 158,
    icon: '🎮',
    title: 'Free Fire Diamond Scam',
    desc: 'Fake websites promising free Free Fire Diamonds.',
    diff: 'med',
    tag: 'Gaming Scam',
    url: 'freefire-free-diamonds.com',
    badge: 'Unlimited Diamonds',
    amount: '50,000 Diamonds',
    amountLabel: 'Free Claim',
    fee: 'Login Required',
    feeNote: 'Offer expires soon',
    fields: [
      { n: 'player', p: 'Player ID', t: 'text' },
      { n: 'password', p: 'Game Password', t: 'password' }
    ],
    ...
    quiz: [
      {
        q: 'What is the goal of Free Fire Diamond scams?',
        opts: ['Steal gaming accounts', 'Improve game graphics', 'Increase FPS', 'Update the game'],
        ans: 0,
        exp: 'Fake diamond generators steal account credentials.'
      },
      {
        q: 'Should you enter your game password on a free diamond website?',
        opts: ['No', 'Yes', 'Only once', 'If it looks professional'],
        ans: 0,
        exp: 'Legitimate rewards never require your password.'
      },
      {
        q: 'Where should you get Diamonds?',
        opts: ['Official Garena events and stores', 'Random websites', 'Telegram bots', 'YouTube links'],
        ans: 0,
        exp: 'Only use official channels to purchase or earn Diamonds.'
      }
    ]
  },

{
    ...
    icon: '🎯',
    title: 'PUBG UC Scam',
    desc: 'Fake PUBG UC generator and reward scam.',
    diff: 'med',
    tag: 'Gaming Scam',
    url: 'pubg-free-uc.com',
    badge: 'Unlimited UC',
    amount: '10,000 UC',
    amountLabel: 'Claim Free',
    fee: 'Verification',
    feeNote: 'Limited offer',
    fields: [
      { n: 'player', p: 'Player ID', t: 'text' },
      { n: 'password', p: 'Account Password', t: 'password' }
    ],
    ...
    quiz: [
      {
        q: 'What do fake PUBG UC generators usually steal?',
        opts: ['Game account credentials', 'Internet speed', 'Phone battery', 'Graphics settings'],
        ans: 0,
        exp: 'They are designed to steal your PUBG account.'
      },
      {
        q: 'Where should UC be purchased?',
        opts: ['Official PUBG stores', 'Random generator websites', 'Telegram bots', 'Unknown links'],
        ans: 0,
        exp: 'Always purchase UC through official platforms.'
      },
      {
        q: 'What is a major warning sign?',
        opts: ['Unlimited free UC promise', 'Official payment receipt', 'Verified account', 'Game update'],
        ans: 0,
        exp: 'There are no legitimate unlimited UC generators.'
      }
    ]
  },

{
    ...
    fields: [
      { n: 'username', p: 'Roblox Username', t: 'text' },
      { n: 'password', p: 'Roblox Password', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'username', p: 'Steam Account Name', t: 'text' },
      { n: 'password', p: 'Steam Password', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'email', p: 'Sign-In ID (Email Address)', t: 'email' },
      { n: 'password', p: 'Password', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'email', p: 'Microsoft Account Email', t: 'email' },
      { n: 'password', p: 'Password', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'applicationNo', p: 'Application Number', t: 'text' },
      { n: 'dob', p: 'Date of Birth', t: 'date' },
      { n: 'cardNumber', p: 'Credit Card Number', t: 'text' }
    ],
...

{
    ...
    fields: [
      { n: 'routingNo', p: 'Routing Number', t: 'text' },
      { n: 'accountNo', p: 'Account Number', t: 'text' }
    ],
...

{
    ...
    fields: [
      { n: 'studentName', p: 'Student Name', t: 'text' },
      { n: 'email', p: 'Parent Email', t: 'email' },
      { n: 'cardNumber', p: 'Credit Card Number', t: 'text' }
    ],
...

{
    ...
    fields: [
      { n: 'routingNo', p: 'Vendor Routing Number', t: 'text' },
      { n: 'accountNo', p: 'Vendor Account Number', t: 'text' }
    ],
...

{
    ...
    fields: [
      { n: 'walletAddress', p: 'Wallet Address', t: 'text' },
      { n: 'privateKey', p: 'Private Key', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'cardNumber', p: 'Debit Card Number', t: 'text' },
      { n: 'atmPin', p: 'ATM PIN', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'walletType', p: 'Wallet Type', t: 'text' },
      { n: 'seedPhrase', p: 'Seed Phrase', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'cardNumber', p: 'Card Number', t: 'text' },
      { n: 'upiPin', p: 'UPI PIN', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'customerId', p: 'Net Banking ID', t: 'text' },
      { n: 'password', p: 'Net Banking Password', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'accountNumber', p: 'Account Number', t: 'text' },
      { n: 'otp', p: 'Bank OTP', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'aadhaar', p: 'Aadhaar Number', t: 'text' },
      { n: 'emailPassword', p: 'Email Password', t: 'password' }
    ],
...

{
    ...
    fields: [
      { n: 'accountNumber', p: 'Account Number', t: 'text' },
      { n: 'ifsc', p: 'IFSC Code', t: 'text' },
      { n: 'panNumber', p: 'PAN Number', t: 'text' }
    ],
...

{
    ...
    fields: [
      { n: 'workEmail', p: 'Work Email Address', t: 'text' },
      { n: 'password', p: 'Corporate Password', t: 'password' }
    ],
...

{
    ...
    fields: [], exposed: ['Full Name', 'Bank Account Details', 'Processing Fee Amount'],
...

  {
    id: 229,
    icon: "🛡️",
    title: "Fake Bumpversion",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Bumpversion workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹43500",
    amountLabel: "Potential Financial & Data Loss",
    fee: "Start Interactive Investigation",
    feeNote: "Simulated forensic environment — Safe sandbox",
    sim: "FakeBumpversionSim",
    reveal: "You discovered the deceptive indicators! Always verify cryptographic signatures, inspect domain certificates, and avoid unverified third-party scripts.",
    flags: [
      "Unverified third-party binary distribution or unsigned scripts",
      "Requests elevated system permissions or sensitive credentials",
      "Lookalike domain names and spoofed communication channels"
    ],
    tips: [
      "Always verify SHA-256 hashes and official digital signatures before installation",
      "Implement multi-factor authentication and strict least-privilege policies",
      "Regularly audit software dependencies and third-party integrations"
    ],
    quiz: [
      {
        q: "What is the primary indicator of a deceptive trap or compromised software workflow?",
        opts: [
          "Regular system updates and verified cryptographic signatures",
          "Mismatched domain signatures, unsigned binaries, and requests for excessive permissions",
          "Using official package managers with multi-factor authentication",
          "Routine network diagnostics and standard SSL encryption"
        ],
        ans: 1,
        exp: "Mismatched domain signatures and requests for excessive system permissions are primary indicators of compromised or lookalike workflows."
      }
    ]
  },

  {
    id: 230,
    icon: "🛡️",
    title: "Fake Burp Suite",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in BurpSuite workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹45000",
...

  {
    id: 231,
    icon: "🛡️",
    title: "Fake Business Today",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in BusinessToday workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹46500",
...

  {
    id: 232,
    icon: "🛡️",
    title: "Fake Call Centre",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CallCentre workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹48000",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Candy",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Candy workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹49500",
...

  {
    id: 234,
    icon: "🛡️",
    title: "Fake Car Insurance",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CarInsurance workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹51000",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Cardano",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Cardano workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹52500",
...

  {
    id: 236,
    icon: "🛡️",
    title: "Fake Carding Forum",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CardingForum workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹54000",
...

  {
    id: 237,
    icon: "🛡️",
    title: "Fake C A T Coaching",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CATCoaching workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹55500",
...

  {
    id: 238,
    icon: "🛡️",
    title: "Fake Chai Point",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in ChaiPoint workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹57000",
...

  {
    id: 239,
    icon: "🛡️",
    title: "Fake Cheque Fund Transfer",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in ChequeFundTransfer workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹58500",
...

  {
    id: 240,
    icon: "🛡️",
    title: "Fake Chi Router",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in ChiRouter workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹60000",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Chisel",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Chisel workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹61500",
...

  {
    id: 242,
    icon: "🛡️",
    title: "Fake Chrome Remote Desktop",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in ChromeRemoteDesktop workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹63000",
    ...
    fee: "Start Interactive Investigation",
    feeNote: "Simulated forensic environment — Safe sandbox",
    sim: "FakeChromeRemoteDesktopSim",
    reveal: "You discovered the deceptive indicators! Always verify cryptographic signatures, inspect domain certificates, and avoid unverified third-party scripts.",
    flags: [
      "Unverified third-party binary distribution or unsigned scripts",
      "Requests elevated system permissions or sensitive credentials",
...

  {
    id: 243,
    icon: "🛡️",
    title: "Fake C I B I L Score",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CIBILScore workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹64500",
...

  {
    id: 244,
    icon: "🛡️",
    title: "Fake Cirrus C I",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CirrusCI workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹66000",
...

  {
    id: 245,
    icon: "🛡️",
    title: "Fake Citrix Xen App",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CitrixXenApp workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹67500",
...

  {
    id: 246,
    icon: "🛡️",
    title: "Fake Clean Architecture",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CleanArchitecture workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹69000",
...

  {
    id: 247,
    icon: "🛡️",
    title: "Fake C N C Machining",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CNCMachining workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹70500",
...

  {
    id: 248,
    icon: "🛡️",
    title: "Fake Coding Bootcamp",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CodingBootcamp workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹72000",
...

  {
    id: 249,
    icon: "🛡️",
    title: "Fake Comet M L",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CometML workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹73500",
...

  {
    id: 250,
    icon: "🛡️",
    title: "Fake Commando V M",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CommandoVM workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹75000",
...

  {
    id: 251,
    icon: "🛡️",
    title: "Fake Commitizen",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Commitizen workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹76500",
...

  {
    id: 252,
    icon: "🛡️",
    title: "Fake Commitlint",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Commitlint workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹78000",
...

  {
    id: 253,
    icon: "🛡️",
    title: "Fake Comp T I A Exam",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CompTIAExam workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹79500",
...

  {
    id: 254,
    icon: "🛡️",
    title: "Fake Construction Permit",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in ConstructionPermit workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹81000",
...

  {
    id: 255,
    icon: "🛡️",
    title: "Fake Content Samurai",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in ContentSamurai workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹82500",
...

  {
    id: 256,
    icon: "🛡️",
    title: "Fake Copper Futures",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CopperFutures workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹84000",
...

  {
    id: 257,
    icon: "🛡️",
    title: "Fake Country Bean",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CountryBean workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹85500",
...

  {
    id: 258,
    icon: "🛡️",
    title: "Fake C O V I D Test Lab",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in COVIDTestLab workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹87000",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Crunch",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Crunch workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹88500",
...

  {
    ...
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CryptoExchange workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹90000",
...

  {
    id: 261,
    icon: "🛡️",
    title: "Fake Crystal Reports",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CrystalReports workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹91500",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Cscope",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Cscope workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹93000",
...

  {
    id: 263,
    icon: "🛡️",
    title: "Fake Cuckoo Sandbox",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CuckooSandbox workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹94500",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Curl",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Curl workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹96000",
...

  {
    id: 265,
    icon: "🛡️",
    title: "Fake Cz Changelog",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in CzChangelog workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹97500",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Dallas",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Dallas workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹99000",
...

  {
    id: 267,
    icon: "🛡️",
    title: "Fake Darkblood",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Darkblood workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹100500",
...

  {
    id: 268,
    icon: "🛡️",
    title: "Fake Dash Coin",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DashCoin workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹102000",
...

  {
    id: 269,
    icon: "🛡️",
    title: "Fake Daveverwer",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Daveverwer workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹103500",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Dbt",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Dbt workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹105000",
...

  {
    id: 271,
    icon: "🛡️",
    title: "Fake Debt Consolidation",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DebtConsolidation workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹106500",
...

  {
    ...
    icon: "🛡️",
    title: "Fake D Ex",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DEx workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹108000",
...

  {
    id: 273,
    icon: "🛡️",
    title: "Fake Demographics Pro",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DemographicsPro workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹109500",
...

  {
    id: 274,
    icon: "🛡️",
    title: "Fake Design Wizard",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DesignWizard workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹111000",
...

  {
    id: 275,
    icon: "🛡️",
    title: "Fake Dial Up Internet",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DialUpInternet workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹112500",
...

  {
    ...
    icon: "🛡️",
    title: "Fake Dieter",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in Dieter workflows.",
    diff: "medium",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹114000",
...

  {
    id: 277,
    icon: "🛡️",
    title: "Fake Digi Locker",
    desc: "Interactive simulation identifying deceptive traps and security vulnerabilities in DigiLocker workflows.",
    diff: "hard",
    tag: "Technical Scams",
    badge: "CRITICAL THREAT",
    amount: "₹115500",
...
export const SCAM_MODULES = MODULES;
