...
export const MINIGAMES = [
  ...
  },
  {
    ...
    data: {
      ...
      content: '<div style="padding:20px;font-family:Segoe UI;background:#1a1a2e;color:#e94560;border:3px solid #e94560;border-radius:8px;text-align:center"><h1 style="margin: 0 0 16px 0; line-height: 1.4; font-size: 24px; display: block; color: #e94560;">&#9888; WINDOWS DEFENDER — CRITICAL ALERT &#9888;</h1><p style="color:white;font-size:16px;line-height:1.5;margin:0 0 16px 0;">Trojan Spyware detected on your PC!<br/>Your passwords, bank details, and photos are AT RISK.</p><p style="color:#ff0;font-size:20px;font-weight:bold;margin:0 0 16px 0;">CALL MICROSOFT SUPPORT NOW: 1-800-555-0199</p><p style="color:#aaa;margin:0 0 16px 0;">Do NOT close this window or your data will be deleted.</p><button style="background:#e94560;color:white;padding:15px 40px;font-size:18px;border:none;border-radius:8px;cursor:pointer">SCAN NOW</button></div>',
      flags: [
